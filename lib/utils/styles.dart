...
abstract class ThemeText {
  ...
  static const TextStyle deadlineText = TextStyle(
  ...
  static const TextStyle textButton = TextStyle(
      color: AppColors.primary, fontSize: 16, fontStyle: FontStyle.italic);
  static const TextStyle skipButton = TextStyle(
      color: AppColors.primary, fontSize: 17, fontWeight: FontWeight.w500);
